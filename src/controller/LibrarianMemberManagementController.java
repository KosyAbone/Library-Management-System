...
public class LibrarianMemberManagementController{
    ...
    @FXML
    private TableColumn<User, String> colMemberType;
    @FXML
    ...
    private void setupTableColumns() {
        ...
        colMemberType.setCellValueFactory(new PropertyValueFactory<>("memberType"));
    }
    ...
    @FXML
    private void btnAddMemberOnAction(ActionEvent event) {
        try {
    ...
    private void btnHomeOnAction(ActionEvent event) throws IOException {
        Navigation.switchNavigation("LibrarianDashboard.fxml", event, 
            controller -> ((LibrarianDashboardController)controller).setUser(currentUser));
    }
